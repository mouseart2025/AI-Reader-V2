...
- **多层级世界地图** — 宏观区域划分（如四大部洲）、多空间层（天界/冥界/洞府副本）、传送门连接、区域内约束求解布局、程序化地形生成、人物轨迹动画、三态战争迷雾、用户可编辑世界结构、16:9 宽画布、智能副本合并、地理上下文面板（Tab 切换）、场景转换分析增强地点层级、两步层级重建（预览变更→确认应用）
