...
除上方正式版外，还提供**体验版**通道，包含尚在打磨的新功能（**实体别名合并/拆分/改名**等节点级编辑、**可读分析报告导出**）。以 **Pre-release** 形式发布，应用内顶栏会显示「体验版」标识。

| 平台 | 体验版下载 |
|------|------|
| macOS | [AI Reader_0.72.0-beta.2_aarch64.dmg](https://github.com/mouseart2025/AI-Reader-V2/releases/download/v0.72.0-beta.2/AI.Reader_0.72.0-beta.2_aarch64.dmg) |
| Windows | [AI Reader_0.72.0-beta.2_x64-setup.exe](https://github.com/mouseart2025/AI-Reader-V2/releases/download/v0.72.0-beta.2/AI.Reader_0.72.0-beta.2_x64-setup.exe) |
